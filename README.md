...
## Environments
- Preview: https://main--edgesite--venkatanarayanbattula.aem.page/
- Live: https://main--edgesite--venkatanarayanbattula.aem.live/
...
1. Open the `edgesite` directory in your favorite IDE and start coding :)
